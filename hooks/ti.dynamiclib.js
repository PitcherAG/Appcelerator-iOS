...
exports.init = function (logger, config, cli, appc) {
	cli.on('build.ios.xcodeproject', {
		pre: function (data) {
			// var scriptPath = '../../frameworks/strip-frameworks.sh'
			// var frameworkPaths = [
			// 	'../../frameworks/LightningSAPSDK.framework',
			// 	'../../frameworks/SAPCommon.framework',
			// 	'../../frameworks/SAPFoundation.framework',
			// 	'../../frameworks/SAPOData.framework'
			// ];
			var scriptPath = '$BUILT_PRODUCTS_DIR/$FRAMEWORKS_FOLDER_PATH/PSPDFKit.framework/strip-framework.sh';
			var frameworkPaths = [
			...
			var SWIFT_VERSION = 5.0; // Change to desired Swift version
